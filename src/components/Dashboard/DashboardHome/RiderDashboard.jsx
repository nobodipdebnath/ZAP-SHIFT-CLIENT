    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 px-4 sm:px-6 lg:px-16 py-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 text-lg">Manage your deliveries and track performance</p>
        </div>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-800">Assigned Parcels</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group bg-white hover:bg-gradient-to-br hover:from-white hover:to-emerald-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <h3 className="text-4xl font-extrabold text-slate-800 mb-2">{totalAssigned}</h3>
            ...
            <div className="group bg-white hover:bg-gradient-to-br hover:from-white hover:to-blue-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <h3 className="text-4xl font-extrabold text-slate-800 mb-2">{inTransit}</h3>
            ...
            <div className="group bg-white hover:bg-gradient-to-br hover:from-white hover:to-green-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <h3 className="text-4xl font-extrabold text-slate-800 mb-2">{delivered}</h3>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group bg-white hover:bg-gradient-to-br hover:from-white hover:to-indigo-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <h3 className="text-4xl font-extrabold text-slate-800 mb-2">{totalParcels}</h3>
            ...
            <div className="group bg-white hover:bg-gradient-to-br hover:from-white hover:to-orange-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <h3 className="text-4xl font-extrabold text-slate-800 mb-2">{myParcelInTransit}</h3>
              <p className="text-slate-600 font-medium">In Transit</p>
            </div>
            ...
            <div className="group bg-white hover:bg-gradient-to-br hover:from-white hover:to-teal-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <h3 className="text-4xl font-extrabold text-slate-800 mb-2">{myParcelInDelivered}</h3>
              <p className="text-slate-600 font-medium">Delivered</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-5">
              <h3 className="text-2xl font-bold text-white">Assigned Parcels Details</h3>
            </div>
            <div className="p-6">
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 text-lg">No parcels assigned yet.</p>
                </div>
              ) : (
                  ...
                  <table className="min-w-full">
                    <thead>
                      <tr className="border-b-2 border-slate-200">
                        ...
                        <th className="py-4 px-6 text-left text-sm font-bold text-slate-700 uppercase tracking-wider">Customer</th>
                        <th className="py-4 px-6 text-left text-sm font-bold text-slate-700 uppercase tracking-wider">Assigned At</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                      {parcels.map((parcel) => (
                        <tr key={parcel._id} className="hover:bg-slate-50 transition-colors duration-150">
                          <td className="py-4 px-6 text-sm font-semibold text-slate-800">{parcel.tracking_id}</td>
                          ...
                          <td className="py-4 px-6 text-sm text-slate-600">{parcel.created_by}</td>
        ...
        <div>
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-5">
              <h3 className="text-2xl font-bold text-white">My Parcels (Recent 5)</h3>
            </div>
            <div className="p-6">
              {loading ? (
                <div className="flex items-center justify-center py-12">
