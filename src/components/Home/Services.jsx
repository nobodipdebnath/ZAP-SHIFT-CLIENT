...
const Services = () => {
    ...
    return (
        <div className='lg:py-25 py-8 my-14 lg:my-25 px-2 lg:px-28 bg-[#03373D] rounded-4xl'>
            ...
            <div className='grid grid-cols-1 mt-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-6 gap-4'>
                {
